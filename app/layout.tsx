...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <title>Gamexso</title>
        <meta name="description" content="Started in 2021, Gamexso has been able to establish itself as India’s Largest Micro e-Sports Tournament & online gaming platform. Gamexso has registered active users and daily active with a new gamer getting registered every minute. It also has a unique fantasy sports concept called Fan Battle." />
